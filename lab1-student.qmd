...
## Supplement Delivery Effect on Mean Tooth Length
...
#Question 11
list(conclusion = "We fail to reject the null hypothesis that there is no difference in mean tooth length between ")
```
